...
public class AccountServiceTest {
  ...
  private static final List<Transaction> TRANSACTIONS =
      Arrays.asList(
          new Transaction(LocalDate.of(2024, 1, 1), 1000),
          new Transaction(LocalDate.of(2024, 1, 2), -100),
          new Transaction(LocalDate.of(2024, 1, 10), 500));
  ...
  @BeforeEach
  public void setUp() {
    accountService = new AccountServiceImpl(transactionRepository, clock, console);
  ...
  public void print_statement() {
    ...
    inOrder.verify(console).printLine("10/01/2024 | 500.00 | 1400.00");
    inOrder.verify(console).printLine("02/01/2024 | -100.00 | 900.00");
    inOrder.verify(console).printLine("01/01/2024 | 1000.00 | 1000.00");
  }
}
